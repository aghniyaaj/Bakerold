...
// --- Logika Nomor Antrian Diperbarui Setiap Hari ---
$current_date = date('Y-m-d'); // Tanggal hari ini dalam format YYYY-MM-DD

// Periksa apakah tanggal terakhir reset nomor antrian berbeda dengan hari ini
if (!isset($_SESSION['last_queue_reset_date']) || $_SESSION['last_queue_reset_date'] !== $current_date) {
    // Jika tanggal berbeda, reset nomor antrian dan simpan tanggal hari ini
    $_SESSION['nomor_antrian_terakhir'] = 0; // Reset ke 0 atau 1, tergantung kebutuhan
    $_SESSION['last_queue_reset_date'] = $current_date;
}

// Tingkatkan nomor antrian untuk transaksi saat ini
